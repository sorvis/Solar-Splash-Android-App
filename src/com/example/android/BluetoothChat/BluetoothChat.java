...
public class BluetoothChat extends Activity {	
	...
	//Solar Splash****************************************************
	//File file = new File(getExternalFilesDir("ssdata"), "test.txt");
	...
	public void clickToggleOn(View view)
	{
		_view.clickToggleGo(view);
	}
	public void goToDataMode(View view)
	{
		setContentView(R.layout.data_view);
		//_view = new view(this, _fileWriter, (ToggleButton) findViewById(R.id.toggleGo), (SeekBar) findViewById(R.id.throttleBar));
		wl.acquire();
	}
    ...
    public void receiveHeaders(String[] headerArray)
    {
    	_processData.updateHeader(headerArray);
    }
    public void receiveData(float[] dataArray)
    {
    	_processData.recieveData(dataArray);
    }
	public void changeThrottle(int value)
	{
		sendMessage("THRO_"+Integer.toString(value)+"\r");
	}
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_READ:
                ...
                // send input to InputParser
                if(!mConnectedDeviceName.equalsIgnoreCase("me"))
                {
					_InputParser.parseMessage(readMessage);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.discoverable:
            ...
            ensureDiscoverable();
            return true;
        case R.id.menuShowInput:
        	_view.menuShowInputClicked();
        	return true;
        }
        return false;
    }
